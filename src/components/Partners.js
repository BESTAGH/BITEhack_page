                    ...
                    <div className="patroni_div">
                        ...
                        <div className="media_div">
                            ...
                            */}
                            ...
                            <Col xs={6} sm={3}  className="media_logo">
                                <a href="https://www.eurostudent.pl/"><Image src={require('../img/partners/media/eurostudent.jpg')} className="logoeuro"  /></a>
                            </Col>
                            <Col xs={6} sm={3}  className="media_logo">
                                <a href="http://itberries.pl"><Image src={require('../img/partners/media/berries.png')} className="logoberries"  /></a>
                            </Col>
